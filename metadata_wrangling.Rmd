...
# analyze temporal signal by species 
...
# write.csv(interrogans_dated, paste0(interrogans_path, "dated_interrogans_acc_list.txt"), quote = FALSE, sep = "\n", col.names = NA, row.names = FALSE)
# length(interrogans_dated$BioSample.Accession)

ggplot(interrogans_dated, aes(x=Year)) +
  geom_bar() +
