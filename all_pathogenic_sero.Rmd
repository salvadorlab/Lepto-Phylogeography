...
pathogenic_sero_db$Serovar_2.x <- unlist(lapply(pathogenic_sero_db$Serovar_2.x, function(x){
  ifelse(x=="Hardjobovis","hardjo-bovis",x)
}[1]))
pathogenic_sero_db$serogroups <-serogroups
# serogroups <- for(pathogenic_sero_db$Serovar_2.x function(x){
#   i=0
#   for (item in serogroup_dict){
#     i=i+1
#     if(x %in% item){
#       return(names(serogroup_dict)[i])
#     }
#   }
# })
# serogroups
# pathogenic_sero_db$Serovar_2.x
```
...
unique(pathogenic_sero_db$Serovar_2.x)
