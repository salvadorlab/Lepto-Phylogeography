...
python /usr/local/apps/gb/spades/3.12.0-k_245/bin/spades.py \
    -o $SRA_PATH/rest_sra_216/assemblies/SAMEA864163 \
    --pe1-1 $SRA_PATH/rest_sra_216/SRAseq/ERR029238_1.fastq.gz \
    --pe1-2 $SRA_PATH/rest_sra_216/SRAseq/ERR029238_3.fastq.gz