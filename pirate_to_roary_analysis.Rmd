...
pca_matrix <- abs_pres_meta %>% subset(c(Serovar_2 != "NA")) %>% subset( BioSample.Accession != "SAMEA864166")
...
pca_plot <- autoplot(pca_pa, data = pca_matrix, colour = 'serogroups',x=1,y=2)
