...
# pathogenic species
pathogenic <- c("interrogans","mayottensis","santarosai","borgpetersenii","dzianensis","alstonii", "adleri","noguchii", "kirschneri", "barantonii", "weilii","putramalaysiae","alexanderi","gomenensis","kmetyi")
# intermediate species
intermediate <- c("andrefontaineae","wolffii","sarikeiensis","fainei","selangorensis","inadai","dzoumogneensis","fluminis","licerasiae","koniamboensis","fletcheri","langatensis","semungkisensis")
# assign isolates to one of the three groups
edited_date_389 %<>% mutate(group=ifelse(species %in% pathogenic, "pathogenic",ifelse(species %in% intermediate, "intermediate","saprophytic/Unknown")))
# save to Rdata
